...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CurvedTabBar",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12CurvedTabBar11AppDelegate")
...
SWIFT_CLASS("_TtC12CurvedTabBar12CurvedTabBar")
@interface CurvedTabBar : UITabBar
...
SWIFT_CLASS("_TtC12CurvedTabBar22CurvedTabBarController")
@interface CurvedTabBarController : UITabBarController
- (void)viewWillAppear:(BOOL)animated;
- (void)viewSafeAreaInsetsDidChange;
- (void)viewDidLoad;
- (void)menuButtonActionWithSender:(UIButton * _Nonnull)sender;
...
@interface CurvedTabBarController (SWIFT_EXTENSION(CurvedTabBar)) <UITabBarControllerDelegate>
...
SWIFT_CLASS("_TtC12CurvedTabBar15EmptyController")
...
SWIFT_CLASS("_TtC12CurvedTabBar17FriendRequestCell")
...
SWIFT_CLASS("_TtC12CurvedTabBar24FriendRequestsController")
...
SWIFT_CLASS("_TtC12CurvedTabBar13RequestHeader")
@interface RequestHeader : UITableViewHeaderFooterView
...
SWIFT_CLASS("_TtC12CurvedTabBar13SceneDelegate")
...
SWIFT_CLASS("_TtC12CurvedTabBar14ViewController")
